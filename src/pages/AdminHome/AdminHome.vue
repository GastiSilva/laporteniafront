<template>
      ...
      <div>
        ...
        >
          ...
          <template v-slot:before>
            <div
              :style="menuCollapsed ? 'width: 50px;' : 'width: 180px;'"
              class="menu-lateral q-pa-md"
            >
              ...
              >
                ...
                <q-tab
                  name="remitos"
                  icon="description"
                  :label="!menuCollapsed ? 'Remitos' : ''"
                  class="tab-item"
                />
                <q-tab
                  name="movimientos"
                  icon="table_chart"
                  :label="!menuCollapsed ? 'Movimientos' : ''"
                  class="tab-item"
                />
                <q-tab
                  name="datos"
                  icon="print"
                  :label="!menuCollapsed ? 'Datos' : ''"
                  class="tab-item"
                />
                <q-tab
                  name="consultarCV"
                  icon="search"
                  :label="!menuCollapsed ? 'Consultar CV' : ''"
                  class="tab-item"
                />
              </q-tabs>
            </div>
  ...
  .menu-lateral {
    ...
    color: white; /* Color del texto en el menú lateral */
    height: 100%; /* Asegura que el fondo ocupe toda la altura del panel */
    display: flex;
  ...
  .tabs-lateral .q-tab__button {
    color: white; /* Color del texto e íconos de las tabs */
  }
  
  /* Estilo para la pestaña activa */
  .tab-item.q-tab--active .q-tab__button {
    background-color: #1e88e5; /* Color de fondo para la pestaña activa */
    color: white; /* Color del texto y el ícono cuando la pestaña está activa */
  }
  
  /* Efecto hover en las tabs */
  .tabs-lateral .q-tab__button:hover {
    background-color: rgba(255, 255, 255, 0.1); /* Efecto hover en las tabs */
  }
  </style>
